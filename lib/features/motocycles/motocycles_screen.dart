...
class MotocyclesScreen extends ConsumerStatefulWidget {
  final String tag = "house";

  const MotocyclesScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => MotocyclesScreenState();
}

class MotocyclesScreenState extends ConsumerState<MotocyclesScreen> {
                    ...
                    children: [
                      ...
                      Center(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: "Введите примерную стоимость мотоцикла (₽)",
                            focusedBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                                color: Colors.purple,
                                width: 2,
